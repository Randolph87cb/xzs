...
同时补充智能训练入口、查看试卷、错题本、首页任务/试卷入口、个人中心和消息中心。批改试卷详情页还未迁移。
...
学生端核心子闭环已经具备可运行基础：可登录、可拉取首页任务和试卷列表、可进入答题页、题目内容使用新 renderer 渲染、可查看考试记录和已完成试卷、可查看错题本、可打开个人中心和消息中心、可创建智能训练卷。该子闭环还不是完整阶段 4，不能进入阶段 5 覆盖切换。
